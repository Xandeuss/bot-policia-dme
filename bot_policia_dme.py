...
CARGOS_DISPONIVEIS = [
    ...
    ("🦅 ABIN", "🦅 ABIN"),
    ("🪖 CIGS", "🪖 CIGS"),
    ("⚜️ Ministério Público", "⚜️ Ministério Público"),
    ("🔱 Corregedoria", "🔱 Corregedoria"),
    ("🕵🏿‍♀️Praça de Elite", "🕵🏿‍♀️Praça de Elite"),
    ("✯ Liderança ✯", "✯ Liderança ✯"),
    ("📱CDT", "📱CDT"),
    ("✎ Centro de Recursos Humanos ✎", "✎ Centro de Recursos Humanos ✎"),
    ("💰 Auditoria Fiscal", "💰 Auditoria Fiscal"),
    ("✨AMAN", "✨AMAN"),
    ("📸 APM", "📸 APM"),
    ("🗂️ Centro de Normas e Desligamentos", "🗂️ Centro de Normas e Desligamentos"),
    ...
    ("☬ Conselho do C.E ☬", "☬ Conselho do C.E ☬"),
    ("☬ Centro de Patrulha ☬", "☬ Centro de Patrulha ☬"),
    ("👨🏽‍⚖️ Empresarial", "👨🏽‍⚖️ Empresarial"),
    ("MYT", "MYT"),
    ("GOPH", "GOPH"),
